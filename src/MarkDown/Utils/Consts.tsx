export const INDEXTEXT = `# 欢迎使用 react-markdown-ts 编辑阅读器
------
## 您可以使用 react-markdown-ts：

### 1. 实时同步预览

我们将 **react-markdown-ts** 的主界面一分为二，左边为**编辑区**，右边为**预览区**，在编辑区的操作会实时地渲染到预览区方便查看最终的版面效果，并且如果你在其中一个区拖动滚动条，我们有一个巧妙的算法把另一个区的滚动条同步到等价的位置，超酷！
