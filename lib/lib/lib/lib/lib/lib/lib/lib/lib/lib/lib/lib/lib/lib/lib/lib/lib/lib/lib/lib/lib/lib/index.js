...
import * as hlmd from './hignlightMarkdown';
import './index.less';
...
var MarkDown = /** @class */ (function (_super) {
    ...
    function MarkDown(props) {
        ...
        _this.highlightMarkDown = function () {
            var divs = $('#markdownContent').find('div');
            hlmd.parseMarkdownDOM(divs);
        };
    ...
    MarkDown.prototype.render = function () {
        return (React.createElement("div", { className: "markdown-wrapper" }, React.createElement(Row, { className: "markdown-row" }, this.state.mode === MarkDownMode.VIEW
            ? null
            : React.createElement(Col, { span: 12 }, React.createElement("div", { id: "markdownContent" }, React.createElement(InputArea, null))), React.createElement(Col, { span: 12 }, React.createElement("div", { id: "htmlContent", onScroll: this.htmlScroll, dangerouslySetInnerHTML: { __html: this.state.html } })))));
    };
    return MarkDown;
}(React.Component));
