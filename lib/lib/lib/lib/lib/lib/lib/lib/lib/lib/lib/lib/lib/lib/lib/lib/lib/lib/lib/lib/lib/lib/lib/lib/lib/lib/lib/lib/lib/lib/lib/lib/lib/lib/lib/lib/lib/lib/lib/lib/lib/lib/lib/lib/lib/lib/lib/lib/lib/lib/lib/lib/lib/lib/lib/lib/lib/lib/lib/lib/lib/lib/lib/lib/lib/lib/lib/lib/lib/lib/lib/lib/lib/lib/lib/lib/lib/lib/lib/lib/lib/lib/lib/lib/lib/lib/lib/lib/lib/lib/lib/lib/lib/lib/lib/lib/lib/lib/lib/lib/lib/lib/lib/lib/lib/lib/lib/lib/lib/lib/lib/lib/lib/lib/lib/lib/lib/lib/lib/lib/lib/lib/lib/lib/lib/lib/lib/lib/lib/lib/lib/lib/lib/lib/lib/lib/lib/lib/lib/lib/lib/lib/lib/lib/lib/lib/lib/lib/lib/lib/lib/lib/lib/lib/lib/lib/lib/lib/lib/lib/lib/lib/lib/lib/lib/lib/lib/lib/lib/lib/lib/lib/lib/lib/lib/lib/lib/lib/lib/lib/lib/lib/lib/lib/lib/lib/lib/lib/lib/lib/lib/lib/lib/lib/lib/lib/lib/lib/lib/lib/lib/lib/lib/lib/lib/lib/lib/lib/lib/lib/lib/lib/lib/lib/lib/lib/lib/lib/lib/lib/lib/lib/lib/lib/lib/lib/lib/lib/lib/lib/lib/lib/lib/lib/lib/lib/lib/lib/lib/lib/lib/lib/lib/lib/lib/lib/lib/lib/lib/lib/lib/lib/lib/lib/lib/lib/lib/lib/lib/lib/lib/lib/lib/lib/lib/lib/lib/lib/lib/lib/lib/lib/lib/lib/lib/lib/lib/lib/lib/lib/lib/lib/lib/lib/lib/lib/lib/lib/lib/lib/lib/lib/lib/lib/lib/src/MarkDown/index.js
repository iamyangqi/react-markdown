...
var MarkDown = /** @class */ (function (_super) {
    ...
    function MarkDown(props) {
        ...
        _this.changeMarkdown = function (e) {
    ...
    MarkDown.prototype.render = function () {
        return (React.createElement("div", { className: "markdown-wrapper" }, React.createElement(Row, { className: "markdown-row" }, this.state.mode === MarkDownMode.VIEW
            ? null
            : React.createElement(Col, { span: 12 }, React.createElement("div", { id: "markdownContent", onChange: this.changeMarkdown, onScroll: this.mkScroll, disabled: this.state.disabled, contentEditable: true })), React.createElement(Col, { span: 12 }, React.createElement("div", { id: "htmlContent", onScroll: this.htmlScroll, dangerouslySetInnerHTML: { __html: this.state.html } })))));
    };
    return MarkDown;
}(React.Component));
