...
var InputArea = /** @class */ (function (_super) {
    ...
    InputArea.prototype.render = function () {
        var _this = this;
        return (React.createElement(AceEditor, { mode: 'markdown', theme: 'github', name: "markdown-code", editorProps: { $blockScrolling: true }, enableBasicAutocompletion: true, enableLiveAutocompletion: true, ref: function (editor) {
