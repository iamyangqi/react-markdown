                ...
                this.state.mode === MarkDownMode.VIEW
                    ...
                    : React.createElement("div", { className: "markdown-part" },
                        React.createElement("div", { id: "markdownContent" },
                            React.createElement(InputArea, { highlightActiveLine: this.highlightActiveLine, onChange: this.onChange, defaultValue: this.defaultValue, value: this.state.value, onScroll: this.mkScroll }))),
                this.split,
