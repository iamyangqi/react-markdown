...
var MarkDown = /** @class */ (function (_super) {
    ...
    MarkDown.prototype.render = function () {
        return (React.createElement("div", { className: "markdown-wrapper" },
            React.createElement(Row, { className: "markdown-row" },
                this.state.mode === MarkDownMode.VIEW
                    ? null
                    : React.createElement(Col, { span: 12 },
                        React.createElement(Input.TextArea, { id: "markdownContent", onChange: this.changeMarkdown, onScroll: this.mkScroll, disabled: this.state.disabled })),
                React.createElement(Col, { span: 12 },
